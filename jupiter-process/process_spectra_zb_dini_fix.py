...
# closest thing: on 11/7 I wrote that Cabanes did something like this (e.g., I think I was looking at Eq. (3) in their supplementary)
...
def en_m(m, Nr, psimc, psims, dini_zs):
    ...
    return jzsm**4 * (psimc**2 + psims**2) # 2 / Nphi # dini weights?
...
if rank == 0:
    ...
    if use_forcing:
        ...
        np.save('processed_spectra_zb_dini_fix_' + output_suffix + '.npy', processed)
else:
