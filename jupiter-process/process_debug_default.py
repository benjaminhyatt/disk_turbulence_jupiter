...
# load in analysis
#f = h5py.File('../jupiter-run/analysis_new_default/analysis_new_default_s1.h5')
f = h5py.File('../jupiter-run/analysis_debug_default/analysis_debug_default_s1.h5')
...
#f = h5py.File('../jupiter-run/analysis_aux_default/analysis_aux_default_s1.h5')
f = h5py.File('../jupiter-run/analysis_debug_default_aux/analysis_debug_default_aux_s1.h5')
...
# instantaneous rates from tau term
...
processed['W_sum'] = W_wz_lap + W_wz_tau + W_wz_adv + W_wz_for + W_wz_dam
processed['W'] = W

processed['w0_tavg'] = np.mean(w0, axis = 0)
processed['drw0_tavg'] = np.mean(drw0, axis = 0)

print('saving output as processed_debug_default.npy')
np.save('processed_debug_default.npy',processed)
