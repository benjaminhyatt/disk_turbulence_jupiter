...
logger.info("this script uses the default tau setup for the main results")
# Parameters
#Nphi, Nr = 256, 128
Nphi, Nr = 512, 256
dealias = 3/2
...
analysis_aux = solver.evaluator.add_file_handler('analysis_debug_aux_changeF_default_tau', sim_dt = 0.1)
...
# main analysis tasks
analysis = solver.evaluator.add_file_handler('analysis_debug_512_256_changeF_default_tau', sim_dt = 0.1)
