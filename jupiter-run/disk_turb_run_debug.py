...
analysis_aux = solver.evaluator.add_file_handler('analysis_debug_aux_512_256_get_cp', sim_dt = 0.1)
...
# main analysis tasks
analysis = solver.evaluator.add_file_handler('analysis_debug_512_256_long_get_cp', sim_dt = 0.1)
...
analysis.add_task(u, layout='c', name='u_c') # for new lap attempt
...
# create checkpoint
checkpoints = solver.evaluator.add_file_handler('checkpoints', sim_dt = 1, max_writes = 1)
