...
default_times = processed['t'][0:int(2*times.shape[0]):2]
plt.plot(default_times, processed['lap_rate_pred_new'][0:int(2*times.shape[0]):2], color = "purple", linewidth = 3, label = r'Laplacian term from u coefficients (D)')
plt.plot(default_times, processed['lap_rate'][0:int(2*times.shape[0]):2], color = "red", label = r'Laplacian term from Integrate (D)')
plt.legend()
plt.xlabel(r'$t$')
...
processed = np.load('../jupiter-process/processed_debug_default.npy', allow_pickle=True)[()]
default_times = processed['t'][0:int(2*times.shape[0]):2]
plt.plot(default_times, processed['tau_rate_pred'][0:int(2*times.shape[0]):2], color = "purple", linewidth = 3, label = r'tau term from tau_u coefficients (D)')
plt.plot(default_times, processed['tau_rate'][0:int(2*times.shape[0]):2], color = "red", label = r'tau term from Integrate (D)')
plt.legend()
plt.ylim(-2e-4, 2e-4)
plt.xlabel(r'$t$')
plt.ylabel(r'$\partial_t W$')
...
processed = np.load('../jupiter-process/processed_debug_default.npy', allow_pickle=True)[()]
default_times = processed['t'][0:int(2*times.shape[0]):2]
plt.plot(default_times, processed['adv_rate_pred'][0:int(2*times.shape[0]):2], color = "purple", linewidth = 3, label = r'advection term from u ωz coefficients (D)')
plt.plot(default_times, processed['adv_rate'][0:int(2*times.shape[0]):2], color = "red", label = r'advection term from Integrate (D)')
plt.legend()
plt.xlabel(r'$t$')
plt.ylabel(r'$\partial_t W$')
plt.tight_layout()
...
processed = np.load('../jupiter-process/processed_debug_default.npy', allow_pickle=True)[()]
default_times = processed['t'][0:int(2*times.shape[0]):2]
plt.plot(default_times, processed['for_rate_pred'][0:int(2*times.shape[0]):2], color = "purple", linewidth = 3, label = r'forcing term from F coefficients (D)')
plt.plot(default_times, processed['for_rate'][0:int(2*times.shape[0]):2], color = "red", label = r'forcing term from Integrate (D)')
plt.xlabel(r'$t$')
plt.legend()
plt.xlabel(r'$t$')
plt.ylabel(r'$\partial_t W$')
...
processed = np.load('../jupiter-process/processed_debug_default.npy', allow_pickle=True)[()]
default_times = processed['t'][0:int(2*times.shape[0]):2]
plt.plot(default_times, processed['W'][0:int(2*times.shape[0]):2], color = 'red', label = 'W (D)')
plt.plot(default_times, np.zeros(default_times.shape[0]), linestyle = 'dashed', color = 'black')
plt.legend()
plt.xlabel(r'$t$')
plt.ylabel(r'$W$')
plt.tight_layout()
