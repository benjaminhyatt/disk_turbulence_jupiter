...
print("W at t=0", processed['W'][0])
plt.figure()
plt.plot(processed['t'], processed['W'], color = 'blue', label = 'W')
plt.xlabel('time')
plt.legend()
plt.title('Domain-averaged vorticity (circulation)')
plt.xscale('log')
plt.yscale('symlog', linthresh=1e-10)
plt.tight_layout()
plt.savefig('circ_' + output_suffix + '.pdf')
print('saving figure: ' + 'circ_' + output_suffix + '.pdf')
